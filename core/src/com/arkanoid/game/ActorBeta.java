...
public class ActorBeta extends Actor {
    ...
    public void setAnimation(Animation<TextureRegion> anim) {
        animation = anim;
        TextureRegion tr = animation.getKeyFrame(0, true);
     ...
     public void setAnimation(Animation<TextureRegion> anim, float time) {
        animation = anim;
        TextureRegion tr = animation.getKeyFrame(time, true);
        float w = tr.getRegionWidth();
        float h = tr.getRegionHeight();
